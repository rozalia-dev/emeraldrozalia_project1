...
| Managed content pages | SiteController queries published/current-locale/scheduled ContentPage; site.page renders body/sections | PageManagerController creates revisions and publishes | Code-level connection verified; workflow proof partial | Preview/publish/schedule/restore and public screenshot tests |
