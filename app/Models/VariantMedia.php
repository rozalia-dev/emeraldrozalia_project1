...
class VariantMedia extends Model
{
    ...
    public function isApprovedPublic():bool{return $this->approval_status==='approved' && (bool)$this->active && (bool)$this->variant?->is_active && (bool)$this->variant?->product?->isPubliclyPublished();}
}
