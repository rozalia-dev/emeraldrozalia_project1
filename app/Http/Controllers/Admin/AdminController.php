...
class AdminController extends Controller
{
    ...
    public function module(Request $request, string $module): View
    {
        ...
        // Keep historical /admin/module/* URLs on the canonical resource
        // contract so existing bookmarks receive real filters, editors,
        // trash/restore actions and the audited action menu.
        return app(ResourceController::class)->index($request, $module);
    }
}
