            ...
            <section class="cat-detail-card">
                ...
                @if($selected)
                    ...
                    <div class="cat-detail-actions">
                        ...
                        <form method="POST" action="{{ route('admin.categories.destroy', $selected) }}" style="grid-column:1/-1" onsubmit="return confirm('Delete {{ addslashes($selected->name) }}? Products assigned to it will become uncategorised and child categories will move to top level.')">
                            @csrf
                            @method('DELETE')
