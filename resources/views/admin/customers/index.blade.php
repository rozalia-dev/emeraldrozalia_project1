    ...
    <aside class="crm-side">
      <section class="crm-card crm-side-card">
        ...
        @if($selected)
          ...
          <div class="crm-mini-tabs" data-crm-tabs><button type="button" class="is-active" data-crm-tab="overview">Overview</button><button type="button" data-crm-tab="orders">Orders</button><button type="button" data-crm-tab="details">Details</button><button type="button" data-crm-tab="addresses">Addresses</button><button type="button" data-crm-tab="history">History</button><button type="button" data-crm-tab="notes">Notes</button></div>
