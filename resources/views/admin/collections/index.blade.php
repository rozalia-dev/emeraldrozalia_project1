...
@php
    ...
    $collectionPayload = function ($collection): array {
        return [
            ...
            'main_category_id' => $collection->main_category_id,
        ...
        <section class="collections-catalog">
            ...
            <div class="collections-table-wrap">
                <table class="collections-table">
                    <thead><tr><th class="collections-check-col"><input type="checkbox" data-collections-select-all aria-label="Select all collections"></th><th>Collection</th><th>Main Category</th><th>Type</th><th>Season / Occasion</th><th>Products</th><th>Status</th><th>Visibility</th><th>Sort Order</th><th>Actions</th></tr></thead>
                    <tbody>
                    ...
                    @empty
                        <tr><td colspan="10" class="collections-empty"><x-icon name="package" size="27" /><strong>No collections match these filters.</strong><span>Create your first collection to start merchandising the catalogue.</span><button class="collections-link-button" type="button" data-collection-create>Add a collection</button></td></tr>
                    @endforelse
                    </tbody>
                </table>
            </div>
