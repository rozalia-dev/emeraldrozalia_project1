...
<div class="page-builder-screen" data-page-builder data-builder-initial="{{ base64_encode(json_encode($builderInitial)) }}" data-builder-approved-media="{{ base64_encode(json_encode($approvedMedia ?? [])) }}">
                ...
                <section class="page-builder-card" id="sections">
                    ...
                    <div class="page-builder-studio">
                        <aside class="page-builder-library">
                            <div><h3>Section library</h3><p>Choose a block to add it to the canvas.</p><p class="page-builder-media-state">Approved public media: {{ count($approvedMedia ?? []) }} assets available</p><p class="page-builder-media-guide">Change public photos and video in <a href="{{ route('admin.site-media.index') }}">Media Manager</a>, approve the asset, then select it in each section.</p></div>
                            ...
                            <button type="button" data-builder-add="cta"><x-icon name="arrow-right" size="17" /><span><strong>Call to action</strong><small>Conversion-focused panel</small></span><x-icon name="plus" size="14" /></button>
                            <button type="button" data-builder-add="form"><x-icon name="message" size="17" /><span><strong>Enquiry form</strong><small>Capture customer requests</small></span><x-icon name="plus" size="14" /></button>
                            <div class="page-builder-library-group"><h4>Homepage sections</h4><p>These blocks map directly to the published homepage renderer.</p></div>
                            <button type="button" data-builder-add="banners"><x-icon name="image" size="17" /><span><strong>Campaign banners</strong><small>Published banner records</small></span><x-icon name="plus" size="14" /></button>
                            <button type="button" data-builder-add="benefits"><x-icon name="star" size="17" /><span><strong>Benefits strip</strong><small>Trust points and service promises</small></span><x-icon name="plus" size="14" /></button>
                            <button type="button" data-builder-add="collections"><x-icon name="package" size="17" /><span><strong>Collection cards</strong><small>Category links and copy</small></span><x-icon name="plus" size="14" /></button>
                            <button type="button" data-builder-add="heritage"><x-icon name="clover" size="17" /><span><strong>Heritage feature</strong><small>Story, media and badges</small></span><x-icon name="plus" size="14" /></button>
                            <button type="button" data-builder-add="products"><x-icon name="shopping-bag" size="17" /><span><strong>Product carousel</strong><small>Live catalog products</small></span><x-icon name="plus" size="14" /></button>
                            <button type="button" data-builder-add="quality"><x-icon name="settings" size="17" /><span><strong>Quality feature</strong><small>Manufacturing story</small></span><x-icon name="plus" size="14" /></button>
                            <button type="button" data-builder-add="franchise"><x-icon name="users" size="17" /><span><strong>Franchise callout</strong><small>Territory opportunity</small></span><x-icon name="plus" size="14" /></button>
                        </aside>
