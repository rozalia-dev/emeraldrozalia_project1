...
<main class="catalogue-print">
    <header class="catalogue-print-head">
        <div class="catalogue-print-brand"><strong>EMERALD ROZALIA LIMITED</strong><span>IRISH MANUFACTURER · LIMERICK, IRELAND</span></div>
