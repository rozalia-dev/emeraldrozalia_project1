...
@section('content')
<section class="catalog-hero catalog-hero-collections"><div class="catalog-breadcrumb"><a href="/">Home</a><x-icon name="chevron-right" size="14" /><span>Collections</span></div><p class="eyebrow">EMERALD ROZALIA LIMITED</p><h1>OUR <em>COLLECTIONS</em></h1><p>Timeless styles. Irish heritage. Explore signature collections crafted in Limerick with precision, passion and a commitment to quality.</p></section>
