...
<header class="site-header" data-public-shell-region="header">
    ...
    @php($headerLogoUrl = data_get($siteLayoutRegions, 'header.logo.url') ?: (data_get($siteSettings, 'theme_assets.header_logo.url') ?: $publicAssetUrl(in_array($headerLogoPath, ['/assets/logo/logo_one_line.png', '/assets/logo/logo_two_line.png'], true) ? $headerLogoPath : '/assets/logo/logo_one_line.png')))
    <a href="{{ url('/') }}" class="brand">
        @if($headerLogoUrl)<img class="brand-logo-image" src="{{ $headerLogoUrl }}" alt="{{ data_get($siteLayoutRegions, 'header.logo.alt', data_get($siteBranding, 'trading_name', 'Emerald Rozalia Limited')) }}">@else<span class="brand-logo-missing">{{ data_get($siteBranding, 'trading_name', 'Emerald Rozalia Limited') }}</span>@endif
    </a>
...
<footer class="site-footer" data-public-shell-region="footer">
    ...
    @php($footerLogoUrl = data_get($siteSettings, 'theme_assets.footer_logo.url') ?: $publicAssetUrl(in_array($footerLogoPath, ['/assets/logo/logo_one_line.png', '/assets/logo/logo_two_line.png'], true) ? $footerLogoPath : '/assets/logo/logo_two_line.png'))
