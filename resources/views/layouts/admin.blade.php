            ...
            'items'=>[
                [
                    ...
                    'children'=>[
                        ...
                        ['route'=>'admin.site-media.index','label'=>'Public Media Library','icon'=>'image','active'=>'admin/resource/site-media*'],
                        ...
                        ['route'=>'admin.categories.index','label'=>'Categories','icon'=>'package','active'=>'admin/resource/categories'],
                        ['route'=>'admin.categories.taxonomy','label'=>'Taxonomy Builder','icon'=>'settings','active'=>'admin/resource/categories/taxonomy*'],
                        ['route'=>'admin.categories.countries','label'=>'Country Master','icon'=>'globe','active'=>'admin/resource/categories/countries*'],
                        ['route'=>'admin.categories.counties','label'=>'County / Region Master','icon'=>'map-pin','active'=>'admin/resource/categories/counties*'],
                        ['route'=>'admin.categories.clubs','label'=>'Club Master','icon'=>'users','active'=>'admin/resource/categories/clubs*'],
