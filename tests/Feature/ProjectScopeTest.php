...
class ProjectScopeTest extends TestCase {
    ...
    public function test_homepage_uses_persisted_typed_sections_without_reference_fixtures():void {$this->get('/')->assertOk()->assertSee(['data-homepage-renderer="persisted-page-sections"','data-home-section="hero"','data-home-section="benefits"','data-home-section="collections"','data-home-section="heritage"','data-home-section="products"','data-home-section="quality"','data-home-section="franchise"','data-public-media-state="awaiting-approved-media"'],false)->assertDontSee('home-page-hero-reference',false)->assertDontSee('home-reference-placeholder',false)->assertDontSee('fallbackProducts',false);}
