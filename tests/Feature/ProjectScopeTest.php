...
class ProjectScopeTest extends TestCase {
    ...
    public function test_product_detail_exposes_interactive_360_viewer_contract():void {$product=Product::create(['name'=>'Spin Cap','slug'=>'spin-cap','sku'=>'SPIN-001','price'=>44.99,'stock'=>8,'spin_images'=>['spin/frame-01.webp','spin/frame-02.webp'],'is_active'=>true]);ProductMedia::create(['product_id'=>$product->id,'type'=>'spin_360','disk'=>'public','path'=>'spin/frame-03.webp','alt_text'=>'Rear angle','sort_order'=>2,'active'=>true]);$this->get('/product/'.$product->slug)->assertOk()->assertSee(['data-product-viewer','data-spin-frames','data-gallery-frames','frame-01.webp','frame-03.webp','360° VIEW','ADD TO CART','TRY IT ON'],false)->assertDontSee('data-spin-viewer',false);}
