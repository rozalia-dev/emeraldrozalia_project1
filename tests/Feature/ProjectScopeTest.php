...
class ProjectScopeTest extends TestCase {
    ...
    public function test_payments_dashboard_renders_preview_and_filter_contract():void {$admin=User::factory()->create(['is_admin'=>true]);$response=$this->actingAs($admin)->get(route('admin.payments',['tab'=>'pending','category'=>'online']));$response->assertOk()->assertSee(['Payments','Total Transactions (This Month)','Payment Summary','Reconciliation Status','Preview data is shown'],false)->assertSee('name="category"',false);}
