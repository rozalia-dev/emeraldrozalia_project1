...
class ProjectScopeTest extends TestCase {
    ...
    public function test_informational_category_and_factory_pages_are_dedicated():void {$this->get('/irish-traditional')->assertOk()->assertSee(['IRISH TRADITIONAL','FLAT CAPS','APPLY FILTERS'],false);$this->get('/irish-heritage')->assertOk()->assertSee(['IRISH HERITAGE','HATS','APPLY FILTERS'],false);$response=$this->get('/factory')->assertOk()->assertSee(['HOW WE','FROM CONCEPT TO CREATION','WELCOME TO VISIT OUR FACTORY','how-we-work-reference.png','factory-reference-hotspot--made','factory-reference-hotspot--quality','factory-reference-hotspot--delivery','factory-reference-hotspot--factory','/global-network','href="/contact"'],false)->assertDontSee('IMAGE PENDING',false)->assertDontSee('mailto:urmos@rozalia.ie',false)->assertDontSee('https://emeraldrozalia.ie',false);$this->assertSame(8,substr_count($response->getContent(),'class="factory-reference-hotspot '));$this->assertFileExists(public_path('assets/brand/how-we-work-reference.png'));}
