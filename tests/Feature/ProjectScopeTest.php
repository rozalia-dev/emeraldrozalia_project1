...
class ProjectScopeTest extends TestCase {
    ...
    public function test_homepage_uses_one_complete_hero_composition():void {$this->get('/')->assertOk()->assertSee(['home-hero-composition','home-page-hero-reference.png','home-page-hero-reference@2x.png','home-hero-hotspot--arrivals','home-hero-hotspot--factory','home-hero-hotspot--tryon'],false)->assertDontSee('hero-source-placeholder',false)->assertDontSee('home-reference-image--hero',false);$this->assertFileExists(public_path('assets/brand/home-page-hero-reference.png'));$this->assertFileExists(public_path('assets/brand/home-page-hero-reference@2x.png'));}
