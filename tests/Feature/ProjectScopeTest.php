...
class ProjectScopeTest extends TestCase {
    ...
    public function test_cart_checkout_dashboard_renders_preview_and_supports_filters():void {$admin=User::factory()->create(['is_admin'=>true]);$response=$this->actingAs($admin)->get(route('admin.cart-checkout',['tab'=>'abandoned','source'=>'Website']));$response->assertOk()->assertSee(['Cart &amp; Checkout','Abandoned Carts','Checkout Steps Funnel','Preview data is shown'],false)->assertSee('name="source"',false);}
